...
Installing the first Next.js 16 project using `create-next-app`, exploring the structure, understanding what and why in the `app/` directory — `page.tsx`, `layout.tsx`, special files.
...
- npm / npx available
- VS Code or WebStorm
- minimum TypeScript version 5.1 (for Next.js 16)
...
![Creating by CLI](attachments/s02-cli-create.png)
...
![Next.js Welcome Page](attachments/s02-welcome-page.png)
...
![alt text](attachments/s02-ts-version-cmd.png)
Select "Use Workspace Version" to ensure you're using the TypeScript version specified in your project (which is required for Next.js 16 features).
![alt text](attachments/s02-ts-version-select.png)
...
![alt text](attachments/s02-hello-page.png)
